...
Deno.test("typesVersions", async () => {
  ...
  assertStringIncludes(
    dts,
    "http://localhost:8080/@redux-saga/core@1.3.0/types/ts4.2/index.d.ts",
  );
  ...
  assertStringIncludes(
    dts2,
    "http://localhost:8080/@redux-saga/types@1.2.1/types/ts3.6/index.d.ts",
  );
  ...
  res4.body?.cancel();
  assertEquals(
    res4.headers.get("x-typescript-types"),
    "http://localhost:8080/web-streams-polyfill@3.3.3/dist/types/ts3.6/polyfill.d.ts",
  );
});
