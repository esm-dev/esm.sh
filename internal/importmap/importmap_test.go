...
func TestAddPackages(t *testing.T) {
	...
	// 4. with config
	{
		...
		if v, ok := im.Imports.Get("react"); !ok || v != "https://next.esm.sh/react@19.2.3/esnext/react.mjs" {
			t.Fatalf("Expected react to be resolved to https://next.esm.sh/react@19.2.3/esnext/react.mjs, got %s", v)
		}
	}
}
