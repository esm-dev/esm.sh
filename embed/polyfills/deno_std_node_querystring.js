/* deno mod bundle
 * entry: deno.land/std/node/querystring.ts
 * version: 0.110.0
 *
 *   $ git clone https://github.com/denoland/deno_std
 *   $ cd deno_std/node
 *   $ esbuild querystring.ts --target=esnext --format=esm --bundle --outfile=deno_std_node_querystring.js
 */
...
function encodeStr(str, noEscapeTable, hexTable2) {
  ...
  for (let i = 0; i < len; i++) {
    ...
    if (c < 55296 || c >= 57344) {
      lastPos = i + 1;
      out += hexTable2[224 | (c >> 12)] + hexTable2[128 | ((c >> 6) & 63)] +
        hexTable2[128 | (c & 63)];
      continue;
    }
    ++i;
    ...
    out += hexTable2[240 | (c >> 18)] +
      hexTable2[128 | ((c >> 12) & 63)] +
      hexTable2[128 | ((c >> 6) & 63)] +
      hexTable2[128 | (c & 63)];
  }
