...
{
  "imports": {
    "react-dom": "https://esm.sh/react-dom@18.2.0?pin=v112&dev",
    "react-dom/": "https://esm.sh/react-dom@18.2.0&pin=v112&dev/",
  }
}
```
...
[![Become a Backer](https://opencollective.com/esm/tiers/backer.svg?avatarHeight=50)](https://opencollective.com/esm)
